...
import { AiOutlineMenu, AiOutlineSearch, AiOutlineClose, AiFillTag ,AiTwotoneHeart  } from 'react-icons/ai';
      ...
      <div className={nav ? 'fixed top-0 left-0 w-[300px] h-screen bg-white z-10 duration-300' : 'fixed top-0 left-[-100%] w-[300px] h-screen bg-white z-10 duration-300' }>
        ...
        <nav>
            <ul className='flex flex-col p-4 text-gray-800'>
                ...
                <li className='text-xl py-4 flex'><AiTwotoneHeart size={20} className='mr-4' /> Favorites</li>
                <li className='text-xl py-4 flex'><FaWallet size={20} className='mr-4' /> Wallet</li>
                <li className='text-xl py-4 flex'><BiHelpCircle  size={20} className='mr-4' />Help</li>
